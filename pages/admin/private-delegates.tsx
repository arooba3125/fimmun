          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-gray-900">Private Delegates</h1>
                  <p className="text-sm text-gray-500">Manage individual delegate registrations</p>
                </div>
              </div>
              <div className="flex items-center space-x-4">
                <select
              ...
              {filteredDelegates.length === 0 ? (
                ...
                <div className="space-y-4">
                  {filteredDelegates.map((delegate) => (
                    <div key={delegate.id} className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                              <p className="text-sm text-gray-600"><strong>Verification Code:</strong> {delegate.verification_code}</p>
                              <p className="text-sm text-gray-600"><strong>Registered:</strong> {new Date(delegate.created_at).toLocaleDateString()}</p>
                              {delegate.mun_experience && (
                                <p className="text-sm text-gray-600"><strong>MUN Experience:</strong> {delegate.mun_experience}</p>
                              )}
                            </div>
                          </div>
